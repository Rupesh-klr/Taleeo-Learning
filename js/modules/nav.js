...
const FRONTEND_MODULES = {
  "admin": [
    ...
    { id: 'admin-webinars', icon: '🌐', label: 'Upcoming Webinars', section: 'My Community' },
    {
      id: 'admin-groups',
      icon: '🤝',
      label: 'Groups',
      ...
      children: [
        { id: 'admin-startup-club', icon: '🚀', label: 'Start up club' },
        { id: 'admin-comm-club', icon: '💬', label: 'Communication club' },
        { id: 'admin-other-courses', icon: '➕', label: 'Other Courses' }
      ]
    }
  ],
  "student": [
    ...
    { id: 'user-profile', icon: '👤', label: 'My Profile', section: 'Settings' },
    { id: 'my-community', icon: '🌐', label: 'My Community', section: 'My Community' },
    { id: 'student-announcements', icon: '📢', label: 'Announcements', section: 'My Community' },
    { id: 'student-webinars', icon: '🌐', label: 'Upcoming Webinars', section: 'My Community' },
    {
      id: 'student-groups',
      icon: '🤝',
      label: 'Groups',
      section: 'My Community',
      children: [
        { id: 'student-startup-club', icon: '🚀', label: 'Start up club' },
        { id: 'student-comm-club', icon: '💬', label: 'Communication club' },
        { id: 'student-other-courses', icon: '➕', label: 'Other Courses' }
      ]
    }
  ]
};
